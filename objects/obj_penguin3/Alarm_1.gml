...
if (instance_exists(obj_player)){
	if(state == states.staticAttack ){
		if (collision_line(x, y, obj_player.x, obj_player.y, obj_wall, false, false)){
			...
			instance_create_layer(x, y, "Instances", obj_enemyHeatSeeking)
			alarm_set(0, 60)
			throwing = true;
